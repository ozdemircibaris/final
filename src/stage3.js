...
const testItem = [
  {
    id: "1",//C
    title: "Text ne işe yarar?",
    a: "State yönetimi",
    b: "Props yönetimi",
    c: "Uygulama içinde metin eklemeyi sağlar.",
    d: "Uygulamaya start verir",
    monCoin: false,
  },
  {
    id: "2",//C
    title: "TouchableOpacity ne işe yarar?",
    a: "Boş alan",
    b: "Metin ekleme",
    c: "Tıklanabilir alan",
    d: "Fotoğraf ekleme",
  ...
  {
    id: "3",//A
    title: "ScrollView ne işe yarar?",
    a: "Ekranı herhangi bir yöne kaydırmaya",
    b: "Metin ekleme",
    c: "Tıklanabilir alan",
    d: "Yazı yazılabilir alan",
    monCoin: false,
  },
  {
    id: "4",//A
    title: "TextInput ne işe yarar?",
    a: "Yazı yazılabilir alan",
    b: "Fotoğraf ekleme",
    c: "Tıklanabilir alan",
    d: "Herhangi bir seçeneği seçmeye yarar.",
    monCoin: false,
  },
]
          ...
          <SafeAreaView style={styles.body}>
            ...
            <FlatList
              ...
              <TouchableOpacity onPress={this.testCalculate} style={{backgroundColor: '#4996b5', width: "50%", borderRadius: 10, padding: 10, alignItems: 'center', justifyContent: 'center', marginTop: 30, alignSelf: 'center', marginBottom: 10}}>
                <Text style={{color: '#fff', fontSize: 17,}}> Testi Bitir </Text>
              </TouchableOpacity>
              <Modal
                animationType="slide"
                transparent={true}
                  ...
                  <View style={styles.modalContainer}>
                    ...
                    }
                    {
                      ...
                      <View>
                        ...
                        {
                          (totalPoint / 25) == 4 ?
                        <Text style={[styles.sectionDescription, { textAlign: 'center', }]}> Testi başarıyla tamamladınız!</Text>:null
                        }
                        {
                          (totalPoint / 25) < 4 ?
                          <Text style={[styles.sectionDescription, { textAlign: 'center', marginHorizontal: 10}]}> Testi tamamlayabilmeniz için bütün soruları doğru cevaplamanız gerekemektedir.</Text>:null
                        }
                        <TouchableOpacity onPress={() => {
                          if(totalPoint / 25 == 4) {
                            Actions.jump('stage1')
                          }
                          this.setState({ modalStatus: false, error: ""})}} style={{backgroundColor: '#4996b5', width: "50%", borderRadius: 10, padding: 10, alignItems: 'center', justifyContent: 'center', marginTop: 30, alignSelf: 'center'}}>
                          <Text style={{color: '#fff', fontSize: 17}}> {(totalPoint / 4) == 4 ? "Anasayfaya Dön":"Testi Bitir"} </Text>
                        </TouchableOpacity>
                      </View>:null
                    }
                  </View>
